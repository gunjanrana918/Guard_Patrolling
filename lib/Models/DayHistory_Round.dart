...
//
//     final dayHistory = dayHistoryFromJson(jsonString);

import 'dart:convert';

DayHistory dayHistoryFromJson(String str) => DayHistory.fromJson(json.decode(str));

String dayHistoryToJson(DayHistory data) => json.encode(data.toJson());
