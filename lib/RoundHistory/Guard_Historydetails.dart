...
import '../Screens/PDFpreview.dart';
import '../Screens/pdfexportfile.dart';

class Historydetails extends StatefulWidget {
  Guardhistory? historydata;
  Historydetails({Key? key, this.historydata,}) : super(key: key);
  @override
  State<Historydetails> createState() => _HistorydetailsState(historydata);
}

class _HistorydetailsState extends State<Historydetails> {
  Guardhistory? newhistory;
  _HistorydetailsState(newhistory){
    print("object");
    print(newhistory);
                              ...
                              child: InkWell(
                                ...
                                onTap: (){
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PdfPreviewPage(historydata: newhistory,)));
                                    },
